...
/* ── static data (hoisted so it isn't recreated every render) ── */
const TEAM_MEMBERS = [
  { img: "/images/team1.jpg", name: "Jane Smith",      role: "Chief Operating Officer" },
  { img: "/images/team2.jpg", name: "Michael Johnson", role: "Chief Technology Officer" },
  { img: "/images/team3.jpg", name: "Sarah Williams",  role: "Head of Marketing" },
    ...
    const obs = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setInView(true);
          obs.disconnect(); // no need to keep observing once revealed
        }
      },
      { threshold }
    );
...
const About = () => {
  ...
  return (
    <div className="about-page">
      ...
      <section className={`about-ceo ${ceoIn ? "section--visible" : ""}`} ref={ceoRef}>
        <div className="about-ceo-img">
          <img src="/images/CEO.png" alt="CEO Shashikant Valatkar" loading="lazy" />
          <div className="ceo-img-ring" />
        </div>
        <div className="about-ceo-text">
          <span className="section-label">Leadership</span>
      ...
      >
        ...
        <div className="team-grid">
          {TEAM_MEMBERS.map((m, i) => (
            <div className={`team-card stagger-${i + 1}`} key={m.name}>
              <div className="team-img-wrap">
      ...
      <section id="careers" className="about-careers">
        <div className="careers-inner">
          ...
          <button type="button" className="career-button">View Open Positions</button>
        </div>
      </section>
      ...
      >
        ...
        <button type="button" className="cta-button">Contact Us</button>
      </section> */}
